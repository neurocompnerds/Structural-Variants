# WISECONDORX 
I think you're supposed to call it Wise Condor X but to me Wise con dorks sounds way more amusing even if it is a meaningless phrase.

This software is for determining copy number variants from low coverage short-read genome sequencing.  To use it you will need to set up the conda environment.
https://github.com/CenterForMedicalGeneticsGhent/WisecondorX

See the HPC wiki for basic set up of conda if you don't already have this (you'll need to login with University of Adelaide credentials to view this):
