...
parser$add_argument("-v", "--vcf", type="string",
    help="You must specify a VCF file to annotate", metavar="vcf_file")
parser$add_argument("-o", "--output", type="string", default="annotated",
    help="File path and output prefix for VCF and BED files [default %(default)s]", metavar="output_prefix")
...
writeVcf(vcf, paste(output_prefix, "vcf", sep = ".")) # generated by example/gridss.sh
...
write.table(simplebed, paste(output_prefix, "bed", sep = "."), quote=FALSE, sep='\t', row.names=FALSE, col.names=FALSE)
